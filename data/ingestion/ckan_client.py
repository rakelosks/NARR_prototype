...
class CKANClient:
    ...
    def __init__(self, base_url: str, timeout: float = 30.0):
        ...
        """
        # Normalize: strip trailing slashes, ensure we point at the API root
    ...
    async def _request(self, action: str, params: Optional[dict] = None) -> dict:
        """Make a GET request to the CKAN API and return the result payload."""
    ...
    async def download_resource_as_dataframe(self, resource: CKANResource):
        ...
        if fmt == "csv":
            ...
            # GeoJSON needs special handling — normalize the features
            import json
